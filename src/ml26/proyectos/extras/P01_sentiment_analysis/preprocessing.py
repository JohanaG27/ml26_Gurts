...
def get_one_hot_vector(text, vocabulary):
    ...
    # TODO: Modifica los valores segun la descripcion
    ...
    for word in text.split():
        if word in vocabulary:
            # Si la palabra esta en el vocabulario, marcamos su posicion con 1
            one_hot[vocabulary[word]] = 1
        else:
            # Si la palabra no esta en el vocabulario, usamos el indice de UNK
