...
if __name__ == "__main__":
    ...
    model_folder = "xgb_12_earlystopping" # Cambia esto por el modelo que quieran usar para la inferencia final. Asegúrense de que exista en trained_models y tenga un model.pkl adentro.
